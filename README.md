...
## Этапы разработки функционала игры
1. Отрисовка поля (создание канваса), кнопок управления для мобильной версии
2. Отрисовка танка по заданным координатам
3. Сделать танк подвижным (нажатием клавиш на клавиатуре / нажатием кнопок в мобильной версии)
4. Отрисовка препятствий
5. Добавление возможности стрелять (клавишами на клавиатуре / кнопками в мобильной версии)
6. Разрушение препятствий при попадании
7. Отрисовка танков противника
8. Уничтожение танков противника при попадании
9. Добавление возможности стрелять танкам противника
10. Уничтожение танка игрока при попадании и механика геймовера (подсчёт очков, показ рейтинга игроков, редирект на начальный экран)
11. Сложный момент: добавление возможности двигаться танкам противника (программирование ИИ)
12. Отрисовка индикаторов (жизни, оставшиеся вражеские танки, текущий уровень)
